...
abstract class Assets {
	...
	public static function get_styles() {
		...
		return apply_filters( 'woorricane_helper_enqueue_styles', array() );
	}
	...
	public static function get_scripts() {
		...
		return apply_filters( 'woorricane_helper_enqueue_scripts', array() );
	}
	...
	public static function load_scripts() {
		...
		if ( ! did_action( 'before_woorricane_helper_init' ) ) {
			return;
		}
